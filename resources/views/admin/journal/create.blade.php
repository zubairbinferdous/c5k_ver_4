        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" name="journal_image" id="journalImage" onchange="previewImage(event)">
                </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="title" class="form-control" id="firstHeading" placeholder="Enter First Heading">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label for="firstContent" class="text-dark">Cite Score</label>
             <input type="text" class="form-control" name="cite_score" placeholder="Enter Cite Score">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label for="firstContent" class="text-dark">Impact Factor</label>
              <input type="text" class="form-control" name="impact_factor" placeholder="Enter Factro">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <textarea class="form-control summernote" id="thirdContent" name="aim_scope"  rows="8" placeholder="Enter Aims & Scope" require></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control"  name="issn_print"  id="thirdHeading" placeholder="Enter ISSN Print">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="thirdContent" class="text-dark">ISSN (Online)</label>
              <input type="text" class="form-control"  name="issn_online"  id="thirdHeading" placeholder="Enter ISSN Online">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <textarea class="form-control summernote" id="thirdContent" name="subject_area"  rows="4" ></textarea>
            </div>
          </div>
          <div class="col-md-6">
          <div class="form-group">
              <label for="secondHeading" class="text-dark">Article Publishing Charge Details <span class="text-danger"> *</span></label>
              <textarea class="form-control summernote" id="thirdContent" name="article_charge"  rows="4" ></textarea>
            </div>
          </div>
        </div>
