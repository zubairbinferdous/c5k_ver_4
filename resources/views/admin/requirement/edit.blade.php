              ...
              <form class="needs-validation" novalidate action="{{ URL::route($url.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" value="{{ $row->title }}" placeholder="Requirement Title" required>

                        <div class="invalid-feedback">
                          Please Provide Requirement Title.
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">
                          Please Provide Requirement Details.
                        </div>
                    </div>
