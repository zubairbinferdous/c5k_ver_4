...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Update Book</h4>

                <form method="POST" action="{{ URL::route('book.list.update', $bookList->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" id="book_name" class="form-control" name="name" value="{{ $bookList->name }}">
                        </div>
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <select class="form-select" id="book_category" name="category_id">
                                ...
                                @foreach ($book_cats as $row)
                                    <option value="{{ $row->id }}" @if($row->id == $bookList->category_id) selected @endif>{{ $row->name }}</option> 
                                @endforeach
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" step="any" value="{{ $bookList->price }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="hard_cover" name="hard_cover" step="any" value="{{ $bookList->hard_cover }}">
                        </div>

                        <div class="col-lg-4 mb-3">
                            <label for="paper_book" class="form-label">Paper Book</label>
                            <input type="number" class="form-control" id="paper_book" name="paper_book" step="any" value="{{ $bookList->paper_book }}">
                        </div>

                        <div class="col-lg-4 mb-3">
                            <label for="online_isbn" class="form-label">Online Isbn</label>
                            <input type="text" class="form-control" id="online_isbn" name="online_isbn" value="{{ $bookList->online_isbn }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="first_isbn" value="{{ $bookList->first_isbn }}" name="first_isbn">
                        </div>

                        <div class="col-lg-4 mb-3">
                            <label for="doi" class="form-label">DOI</label>
                            <input type="text" class="form-control" id="doi" value="{{ $bookList->doi }}" name="doi">
                        </div>

                        <div class="col-lg-4 mb-3">
                            <label for="type" class="form-label">Type</label>
                            <input type="text" class="form-control" id="type" value="{{ $bookList->type }}" name="type">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $bookList->items_weight }}" id="items_weight" name="items_weight">
                        </div>

                        <div class="col-lg-4 mb-3">
                            <label for="dimention" class="form-label">Dimention</label>
                            <input type="text" class="form-control" value="{{ $bookList->dimention }}" id="dimention" name="dimention">
                        </div>

                        <div class="col-lg-4 mb-3">
                            <label for="copyright" class="form-label">Copyright</label>
                            <input type="text" class="form-control" value="{{ $bookList->copyright }}" id="copyright" name="copyright">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <select class="form-select" name="status">
                                ...
                                <option value="1" @if( $bookList->status == 1 ) selected @endif>Active</option>
                                <option value="0" @if( $bookList->status == 0 ) selected @endif>Deactive</option>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3 ">
                            ...
                            <input class="form-control published_date" type="date" id="published_date" name="published_date" placeholder="Select a date...." value="{{ $bookList->published_date }}">
                        </div>
                    </div>

                    <div class="col-12 mb-3">
                        <label for="author_name" class="form-label">Author Name</label>
                        <input type="text" class="form-control author_name" id="author_name" name="authors" value="{{ $bookList->authors }}" placeholder="Author Name Here....">
                    </div>

                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="book_desc" class="form-label"><strong>Description</strong> <sup class="text-danger">*</sup></label>
                            <textarea class="form-control" id="book_desc" name="description" rows="8">{!! $bookList->description !!}</textarea>
                        </div>
                    </div>
