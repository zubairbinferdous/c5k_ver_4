...
<div class="container">
    <div class="journal-section">
        <h1 class="journal-title">Journal of Sustainable Agricultural Economics</h1>

        <div class="editor-info">
            <h4 class="editor-in-chief">Editor-in-Chief</h4>
            <p>Dr. Md. Saiful Islam,<br>University Malaysia Sarawak, Malaysia & Bangladesh Army University of Engineering and Technology, Bangladesh</p>
        </div>
        ...
        <div class="list-group editorial-board">
            ...
            <div class="list-group-item">Dr. Md. Habibur Rahman Sobuz, The University of Adelaide, Australia & Khulna University of Engineering and Technology, Bangladesh</div>
