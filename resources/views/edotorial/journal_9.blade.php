...
<head>
  ...
  <title>International Law, Policy Review, and Organizational Management</title>
@include('layout.css')
<style>
        body {
...
<div class="container">
    <div class="journal-section">
        <h1 class="journal-title">International Law, Policy Review, and Organizational Management</h1>
