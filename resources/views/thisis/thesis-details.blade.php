...
<body>
    ...
    @section('content')
        <div class="container py-5">
            <div class="row">
                ...
                <!-- Book Details -->
                <div class="col-md-8 common-font" ">
                <h1 class="fw-bold"  style="font-family: Georgia, serif">{{ $thesis->name }}</h1>
                <p class=""><strong>Authors:</strong> {{ $thesis->authors }}</p>
    ...
    <p><strong>First Published:</strong> {{ \Carbon\Carbon::parse($thesis->published_date)->format('d-m-Y') }}</p>
                <p class="text-primary"><strong>DOI:</strong> {{ $thesis->doi }}</p>
                <p class="text-primary"><strong>Copyright</strong> &copy; {{ $thesis->copyright ?? 'C5K Research Publishing' }}</p>
        ...
        <div class="my-4 col-md-4 d-flex justify-content-start">
            <div class="card w-100">
                <div class="card-header fw-bold text-center text-white" style="background-color:RGB(0, 154, 203)">
                    <strong>Thesis Specifications</strong>
                </div>
     ...
     <!-- About Section -->
    <div class="row mt-5 common-font">
        <div class="col-12">
            <h3>About this Thesis</h3>
            <p class="text-justify">{{ $thesis->description }}</p>
        </div>
    </div>


         <div class="container my-4" style="  font-family: Georgia, serif;
          ">
        ...
        <div class=" my-4" style="font-family: Georgia, serif;">
            ...
            <div class="mb-3">
                ...
                <div class="mt-1">
                    ...
                    <a href="{{ url('pdf_view_thesis') }}?file={{ $front->pdf_url }}" 
        ...
        @endforeach  --}}
                    ...
                    <div class="container border rounded p-3 shadow-sm">
                        <div class="text-center  shadow p-2 " style="font-weight:600;background:#F0F8FF">
                            <h1 class="text-primary text-center">Purchase This Thesis</h1>
                        </div>
                        <div class="row mt-3 border-top pt-3">
                            <div class="col-4 text-center border rounded p-2" style="background-color: RGB(250, 244, 0)">
                                <p class="mb-1" style="font-size:24px;font-weight:600">E-thesis</p>
                                <p> <span class="fw-bold" style="font-size:22px">from
                                        ${{ $thesis->price ?? 'N/A' }}</span></p>
                            </div>
                            <div class="col-4 text-center border rounded text-white p-2"
                                style="background-color:RGB(0, 154, 203)">
                                <p class="mb-1" style="font-size:24px;font-weight:600">Paper Back</p>
                                <p class="fw-bold"style="font-size:22px">from ${{ $thesis->paper_book ?? 'N/A' }}</p>
                            </div>
                            <div class="col-4 text-center border rounded text-black p-2"
                                style="background-color: RGB(250, 244, 0)">
                                <p class="mb-1" style="font-size:24px;font-weight:600">Hard Cover</p>
                                <p> <span class="fw-bold" style="font-size:22px">from
                                        ${{ $thesis->hard_cover ?? 'N/A' }}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
