...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="{{ URL::route('reviewer.'.$url.'.'.$route_name) }}" class="btn btn-info">Refresh</a>
        </div>
    </div>
                        ...
                        <tbody>
                          @foreach( $rows as $key => $row )
                            <tr>
                                ...
                                <td>{!! str_limit(strip_tags($row->category->title ?? ''), 30, ' ...') !!}</td>
                                <td>
                                    <a href="{{ URL('/dashboard/reviewer/issue/'.$row->id) }}" class="btn btn-primary btn-sm">Issues</a>
                                </td>
                                <td>
