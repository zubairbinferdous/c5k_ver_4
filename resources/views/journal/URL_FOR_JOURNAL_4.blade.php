...
<head>
  ...
  <title>Advances in Machine Learning, IoT and Data Security</title>
@include('layout.css')
<style>
    .aims-scope-section {
...
.aims-scope-section h2 {
    color: #2C3E50;
    font-size: 24px;
    margin-bottom: 15px;
}

.aims-scope-section p {
    color: #5D6D7E;
    font-size: 16px;
    line-height: 1.6;
    margin-bottom: 20px;
...
.aims-scope-section li b {
    color: #2E86C1;
}

.aims-scope-section i {
    font-style: italic;
    color: #2C3E50;
}
...
<section class="py-3">
      <div class="container d-flex flex-column justify-content-center" style="height: auto; background-color:#142141;">
        <div class=" text-white p-4">
           <div class="row">
              <div class="col-md-2 col-lg-2 col-sm-6">
              <img src="{{ asset('public/front/images/papers/Journal-4.png') }}" class="img-fluid">
              </div>
              <div class="col-md-10 col-lg-10 col-sm-6 d-flex flex-column justify-content-center">
                <h4>Advances in Machine Learning, IoT and Data Security</h4>
                <h6>Open Access</h6>
             </div>
           </div>
        </div>        
...
<ul class="nav-list navbar-nav-bottom mt-2">
            ...
            <li class="nav-item-bottom dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="aboutDropdown">
                    ...
                    <a class="dropdown-item" href="{{route('journal_4')}}">Editorial Board</a>
    ...
    <div class="container">
      <div class="row mt-3 d-flex justify-content-between" style="border-bottom: 1px solid #E4E4E4;">
       ...
       <div class="row pb-3" style="border-bottom: 1px solid #E4E4E4;">
        ...
        <div class="col-md-9 col-lg-9 col-sm-6"><h6 class="mt-4 mb-3">Advances in Machine Learning, IoT and Data Security is a leading international journal dedicated to the advancement of knowledge in the interconnected fields of machine learning, the Internet of Things (IoT), and data security. The journal aims to serve as a platform for both researchers and industry professionals to explore cutting-edge innovations, theoretical advancements, and practical applications within these rapidly evolving domains.
        ...</h6>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="aimsModalLabel">Advances in Machine Learning, IoT and Data Security
        </h5>
...
<h2><b>Aim and Scope</b></h2>
    <p>
        <i>Advances in Machine Learning, IoT, and Data Security</i> is a leading international journal dedicated to the advancement of knowledge in the interconnected fields of machine learning, the Internet of Things (IoT), and data security. The journal aims to serve as a platform for both researchers and industry professionals to explore cutting-edge innovations, theoretical advancements, and practical applications within these rapidly evolving domains.
    </p>
    <p>
    ...
    <ul>
        <li><b>Research Articles:</b> Original contributions exploring innovative methodologies, algorithms, and applications in machine learning, IoT systems, and data security.</li>
        <li><b>Review Articles:</b> Comprehensive reviews that critically assess state-of-the-art technologies and propose future directions in machine learning, IoT, and data security.</li>
        <li><b>Application and Case Studies:</b> Real-world implementations of machine learning models, IoT architectures, or data security protocols that demonstrate their impact on industries such as healthcare, finance, smart cities, and more.</li>
        <li><b>Technical Notes:</b> Brief reports on emerging techniques, tools, and technologies that address challenges in the integration of machine learning, IoT, and security.</li>
    </ul>
    <p>
