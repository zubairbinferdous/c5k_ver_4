...
<head>
  ...
  <title>International Law Policy Review Organizational Management</title>
@include('layout.css')
<style>
...
<section class="py-3">
      <div class="container d-flex flex-column justify-content-center" style="height: auto; background-color:#240D0E;">
        <div class=" text-white p-4">
           <div class="row">
              <div class="col-md-2 col-lg-2 col-sm-6">
              <img src="{{ asset('public/front/images/papers/Journal-9.png') }}" class="img-fluid">
              </div>
              <div class="col-md-10 col-lg-10 col-sm-6 d-flex flex-column justify-content-center">
                <h4>International Law Policy Review Organizational Management
                </h4>
                <h6>Open Access</h6>
             </div>
           </div>
...
<ul class="nav-list navbar-nav-bottom mt-2">
            ...
            <li class="nav-item-bottom dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="aboutDropdown">
                    ...
                    <a class="dropdown-item" href="{{route('journal_9')}}">Editorial Board</a>
    ...
    <div class="container pb-5" style="background-color: #E2F1FB;">
      ...
      <h6 class="mt-4 mb-3">The International Law Policy Review Organizational Management seeks to provide a multidisciplinary platform for scholarly research that examines the intersections of international law, policy formulation, and organizational management, fostering a deeper understanding of how legal frameworks influence organizational practices and decision-making processes in a global context...
      </h6>
    ...
    <div class="container">
      <div class="row mt-3 d-flex justify-content-between" style="border-bottom: 1px solid #E4E4E4;">
       ...
       <div class="row pb-3" style="border-bottom: 1px solid #E4E4E4;">
        ...
        <div class="col-md-9 col-lg-9 col-sm-6"><h6 class="mt-4 mb-3">The International Law Policy Review Organizational Management seeks to provide a multidisciplinary platform for scholarly research that examines the intersections of international law, policy formulation, and organizational management, fostering a deeper understanding of how legal frameworks influence organizational practices and decision-making processes in a global context...</h6>
      ...
      <div class="row pb-3" style="border-bottom: 1px solid #E4E4E4;">
        ...
        <div class="col-md-9 col-lg-9 col-sm-6"><h6 class="mt-4 mb-3">⦁	International Law and Global Governance
⦁	Public Policy and Legal Frameworks
⦁	Organizational Management and Leadership
⦁	International Trade Law and Economic Policy
⦁	Human Rights Law and Policy Development
⦁	Environmental Law and Sustainability
⦁	Corporate Law and Compliance
⦁	Legal Aspects of Organizational Change
⦁	International Arbitration and Dispute Resolution
⦁	Regulatory Affairs and Policy Implementation
⦁	Legal Risk Management in Organizations
⦁	Labor Law and Workforce Policy
⦁	Technology and Intellectual Property Law
⦁	Cross-Border Corporate Governance
⦁	Public Administration and Legal Policy
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="aimsModalLabel">International Law Policy Review Organizational Management</h5>
...
<div class="aim-scope-section">
    ...
    <p>
        <i>The International Law Policy Review Organizational Management</i> seeks to provide a multidisciplinary platform for scholarly research that examines the intersections of international law, policy formulation, and organizational management, fostering a deeper understanding of how legal frameworks influence organizational practices and decision-making processes in a global context.
    </p>
    <p>
        The journal aims to publish original empirical and theoretical research that explores key topics such as the impact of international legal standards on organizational behavior, the role of policy in shaping management strategies, and the effectiveness of governance structures in promoting compliance and ethical practices across diverse organizational settings. By encouraging contributions that blend legal analysis with management theory, the journal aspires to enhance the discourse on best practices and innovative solutions for navigating the complexities of international law in organizational contexts.
    </p>
</div>
...
<div class="about-section">
    <h2><b>About</b></h2>
    <p>
        The journal <i>International Law Policy Review Organizational Management</i> offers critical insights into how international legal frameworks and policy decisions shape organizational practices, guiding managers in navigating the complexities of compliance and ethical governance in a globalized environment.
    </p>
</div>
